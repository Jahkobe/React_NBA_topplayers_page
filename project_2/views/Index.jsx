                ...
                <ul>
                    {
                        players.map((player, i) => {
                            ...
                            <img src={player.imageee} alt="" style={{width:100, height:100}}/> <br/>
                            {player.name} played for the {player.team} and averaged {player.ppg} over his career. He went on to win {player.championships} championship.<br></br>
